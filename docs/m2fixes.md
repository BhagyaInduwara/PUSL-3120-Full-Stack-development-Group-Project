...
- **Linked Production Jobs to Sales Orders & Customers:** Enhanced Production Job schema, API controllers, seed scripts, and UI to display linked Sales Order badges (`[ ORD-... ]`) and Customer names for clear Make-to-Order manufacturing traceability.
